...
var articles = [
    ...
    },
    {
        id: "13",
        title: "Возвращение легенды: представлены новые смартфоны под брендом Nokia",
        summary: "На выставке MWC 2017 в Барселоне компания HMD Global, которая  на выпуск смартфоновNokia, представила новые Android-смартфоны разных ценовыхкатегорий — Nokia 3, Nokia 5 и Nokia 6.",
        createdAt: new Date('2017-02-26T20:31:00'),
        author: "Brama",
        content: "Nokia 3 — самый бюджетный аппарат из всей линейки, он стоит от 147 долларов США.Смартфон получил металлический корпус с задней панелью из поликарбоната, 5,2-дюймовый экран с разрешением 1280 на 720 пикселей, процессор MTK 6737, 2 ГБ оперативной и 16 ГБ встроенной памяти, а также фронтальную и основную камеры на 8 Мп. Емкость батареи — 2650 мАч.",
        imageSrc: "images/10.jpg",
...
function logTests() {
    ...
    var newArticle = {
        ...
        author: 'Brama-adder',
        content: 'New article summary',
        imageSrc: "images/10.jpg",
        tags: ["MWC 2017", "Гаджеты", "Смартфоны", "Выставки", "Дизайн"]
    };
    var invalidTagsArticle = {
        id: '25',
        title: 'Invalid article',
        summary: 'Invalid article summary',
        createdAt: new Date('2017-02-27T23:10:54'),
        author: 'Brama-invalid',
        content: 'Invalid article summary',
        imageSrc: "images/10.jpg",
        tags: ["MWC 2017", "Гаджеты", "Смартфоны", "Выставки", "Надоело писать код в час ночи"]
    };
    var validArticle = {
        id: '25',
        title: 'New article',
    ...
    console.log('\n' + "------editArticle(2,articleToChange)-------");
    editArticle(2, articleToChange);
    console.log('\n' + "------editArticle(1,null)-------");
    console.log(editArticle(1, null));
